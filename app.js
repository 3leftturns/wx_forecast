...
// Define the `wxForecast` module
var wxForecast = angular.module('wxForecast', []);

// Define the `WxForecastController` controller on the `wxForecast` module
wxForecast.controller('WxForecastController', function WxForecastController($scope) {
  $scope.forecastday = [
        {
          "period": 0,
          "icon": "partlycloudy",
